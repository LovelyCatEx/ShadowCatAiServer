package com.lovelycatv.ai.shadowcatai.share.im.message;
...
public class MessageChain implements Serializable {
    ...
    public static MessageChain decodeJSON(String json) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            Class<? extends Message> jsonClass = switch (jsonObject.getString("type")) {
                case "TEXT" -> TextMessage.class;
                case "FUNC_CALLBACK" -> CallBackMessage.class;
                case "FUNC_LOGIN" -> LoginMessage.class;
